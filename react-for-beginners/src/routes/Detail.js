...
function Detail() {
  ...
  const getMovieDetail = async() => {
    const json = await (await fetch(`https://api.themoviedb.org/3/movie/${id}?language=ko-KR&api_key=5984953a74d52b49b9aa45ad23721fa5`)).json();
    setMovie(json);
    setLoading(false);
  }
  const getCountry = async() => {
    const json = await (await fetch(`https://api.themoviedb.org/3/configuration/countries?language=ko-KR&api_key=5984953a74d52b49b9aa45ad23721fa5`)).json();
    setCountryName(json);
  }
  const getCredit = async() => {
    const {cast, crew} = await (
      await fetch(`https://api.themoviedb.org/3/movie/${id}/credits?language=ko-KR&api_key=5984953a74d52b49b9aa45ad23721fa5`)
    ).json();
